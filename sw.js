...
self.addEventListener('fetch', e => {
  ...
  if (url.includes('/js/add.js') || url.includes('/js/study.js') || url.includes('/js/dossie.js') || url.includes('/js/known.js') || url.includes('/js/kindle-db.js') || url.includes('/js/epub.js') || url.includes('/js/ler.js') || url.includes('/js/estante.js') || url.includes('/js/manga.js') || url.includes('/js/video')) {
    e.respondWith(
      fetch(e.request)
